...
to use it to make a donation to mozilla.org\_. Mozilla uses Coinbase\_
...
3. Using whatever wallet application you want (which for me is usually
   Electrum\_) you send the necessary funds to that payment hash.
...
worked very well. However, due to my offline wallet\_'s screwy,
...
including the Coinbase Merchant Checkout API docs\_ (which seem to be
...
[2] Of course, right after publishing this article I found this
    link\_ that explains how late payments are handled.
