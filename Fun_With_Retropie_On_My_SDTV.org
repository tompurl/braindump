...
Just like the last time I did this I chose to use [[https://retropie.org.uk/][Retropie]] Linux
...
Retropie and everything it includes is also free and open source
...
like it when you turn it on without first plugging in a controller.
#+END_WARNING

The first time Retropie will notice that your micro sdhc card is
bigger than 2 GB and it will automatically resize the partitions. 
This is a good thing but it will also require a reboot.
...
2. Log into the Retropie system and edit the file using =vi=. 
